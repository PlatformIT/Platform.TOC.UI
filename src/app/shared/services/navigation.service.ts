...
export class NavigationService {
    ...
    createMenu(): void {
        if (localStorage.getItem("roles") == '"admin"') {
            this.defaultMenu.push({
                ...
                sub: [
                    ...
                    { icon: 'i-Over-Time', name: 'الاقسام', state: '/dashboard/department', type: 'link' },
                    { icon: 'i-Over-Time', name: 'تقارير التدقيق', state: '/dashboard/report-check', type: 'link' },
        ...
        } else if (localStorage.getItem("roles") == '"contract"' || localStorage.getItem("roles") == '"assignment"') {
            this.defaultMenu.push({
                name: 'الساعات الاضافية',
                // description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit.',
                type: 'dropDown',
        ...
        else if (localStorage.getItem("roles") == '"audit"') {
            this.defaultMenu.push({
                name: 'الساعات الاضافية',
                // description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit.',
                type: 'dropDown',
